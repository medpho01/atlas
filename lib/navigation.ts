...
export const NAV: NavGroup[] = [
  ...
  },
  {
    ...
    noun: 'places',
    items: [
      { href: '/pincodes', label: 'Pincodes', feature: 'coverage', alsoActiveOn: ['/pincode'] },
      ...
      { href: '/heatmap', label: 'Heatmap', feature: 'coverage' },
      { href: '/coverage', label: 'Serviceability check', feature: 'coverage' },
    ],
  },
  {
    label: 'Directory',
  ...
  },
  {
    ...
    items: [
      ...
      { href: '/pricing', label: 'Tests & rates', feature: 'catalogue' },
