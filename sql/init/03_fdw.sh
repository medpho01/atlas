...
TABLES='"Appointment","Chain","DOS","Lab","LabDepartment","Master","Methodology","Order","Package","PackagesOnLab","PharmaOrder","Pharmacy","PincodeToLatLong","Profile","Provider","ProviderType","Request","PackagesOnStore","SampleType","Store","User","_MasterToPackage","_OrderToPackage","_PackageToRequest","_MasterToRequest","LabsOnStore"'
